...
#### TRY CENTERING / STANDARDIZING DATA

mydir= "C:\\Users\\Buckley\\Google Drive\\ColiasEvolution\\HistoricalAnalysis\\"

#mydir= "C:\\Users\\hmaclean\\Dropbox\\Chapter Three\\Google Drive\\"    #@ I dont have google drive installed so I downloaded the data at 4:29p 9.23.15 to Dropbox
...
#abs=read.table("Region1.SummerTemp.txt", header = T)  #Miscellaneous NA terms "na", "NaN"
abs=read.csv("Region1SummerTemp.csv")
